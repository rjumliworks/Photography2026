                            ...
                            <div class="card-header bg-primary">
                                <div class="d-flex mb-n2">
                                    ...
                                    <div class="flex-grow-1">
                                        <h5 class="mb-0 mt-2 fs-14"><span class="text-white fw-semibold text-uppercase fs-13">TasweerHub</span></h5>
                                        <p class="text-white fs-11">Premium Media Sharing & Client Showcase Platform</p>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="tab-pane fade" :class="activeTab == 4 && 'show active'" id="pills-success" role="tabpanel" aria-labelledby="pills-success-tab">
                                            <div>
                                                <hr class="text-muted mt-n2"/>
                                                 <div class="mb-2 mt-2">
                                                    <div>
                                                        <h5 class="fs-12 mb-1 text-success fw-semibold"><i class="ri-checkbox-circle-line me-1"></i>Review and Activate</h5>
                                                        <!-- <p class="fs-10 text-muted">
